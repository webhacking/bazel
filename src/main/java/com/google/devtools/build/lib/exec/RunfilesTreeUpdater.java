...
public class RunfilesTreeUpdater {
   ...
   *
   * <p>Maintains a mapping of runfiles directory to a monitor. The monitor maintains a counter
   * that tracks how often it has been acquired. If the count drops to zero the mapping is removed.
   */
  @GuardedBy("lock")
